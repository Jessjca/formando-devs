...
<div id="container">
    <div id="wrapper">
        <div class="col-a">
            ...
            <p>2022, Plaker, Planning Poker.</p>
          ...
          <div class="col-b">
            <ul class="social-links">
              <li>
                <a href="https://www.instagram.com/"><svg class="insta" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="https://pt-br.facebook.com/">
                  <svg class="face" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
